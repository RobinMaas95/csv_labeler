...
def get_classification(categories: list) -> str:
    ...
    """
    casefold()_category_list = [x.casefold()() for x in categories]
    category_integer_list = list(range(1, len(casefold()_category_list) + 1))
    ...
    while True:
        ...
        if selected_category.casefold()() in casefold()_category_list:
            clear_console()
